...
public class Weather extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/mpradhan/Documents/My%20Received%20Files/17-03-2017/camel-test/src/main/resources/wsdl/weather.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Weather.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/mpradhan/Documents/My%20Received%20Files/17-03-2017/camel-test/src/main/resources/wsdl/weather.wsdl");
        }
        WSDL_LOCATION = url;
    }
